...
from double_q_learning_agent import double_q_learning_A
...
class double_q_learning_T:
    def __init__(self,
        ...
        self.agent = double_q_learning_A(
    ...
    def train(self):
        ...
        while self.current_episode < self.episodes:
            ...
            if self.enable_save and self.current_episode % self.save_freq == 0:
                ...
                self.summary.write_for_plot(self.current_episode)
                self.summary.clear()
